...
- (id)initWithFrame:(CGRect)frame AndCallingButton:(nonnull UIButton *)cb
{
    ...
    if (self)
    {
        ...
        operatorView = [[UIView alloc] initWithFrame:CGRectMake(0, fflv.frame.origin.y + fflv.frame.size.height, frame.size.width, 128)];
        [self addSubview:operatorView];
        
        UIButton *equalsButton = [[UIButton alloc] initWithFrame:CGRectMake(8, 4, 40, 40)];
        ...
        UIButton *lessThanButton = [[UIButton alloc] initWithFrame:CGRectMake(56, 4, 40, 40)];
        ...
        UIButton *greaterThanButton = [[UIButton alloc] initWithFrame:CGRectMake(104, 4, 40, 40)];
...
- (void)operatorButtonPressed:(UIButton *)sender
{
    ...
    [textView setText:[textViewString stringByAppendingString:operation]];
}
